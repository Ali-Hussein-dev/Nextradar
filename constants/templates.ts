...
export const templates: Template[] = [
  ...
  },
  {
    ...
    name: "Indie Starter",
    description:
      "Visually-stunning, easy to customize site templates built with React 19, Next.js 15, Supabase and shadcn UI",
  ...
  },
  {
    ...
    description: "Expand your audience, showcase your offerings, and boost your visibility",
  ...
  },
  {
    ...
    ogImage: "https://irsyad.co/images/og-image/og.png",
    rel: "nofollow",
    specs: {
      cms: [],
      cost: getPair("cost", "premium"),
  ...
  },
  {
    ...
    ogImage: "https://chat-sdk.dev/opengraph-image.png",
    rel: "nofollow",
    specs: {
      cms: [],
      cost: getPair("cost", "free"),
  ...
  },
  {
    ...
    specs: {
      ...
      email: getPair("email", ["sendgrid", "postmark", "nodemailer", "resend", "plunk"]),
      analytics: getPair("analytics", [
        "googleAnalytics",
        "openPanel",
        "posthog",
  ...
  //     ogImage: "https://indiekit.pro/opengraph-image-rzvgub.png?b78e234fd45eb6a8",
  //     rel: "nofollow",
  //     specs: {
  //     cms: getPair("cms", []),
  //     cost: getPair("cost", "premium"),
  ...
  },
  {
    ...
    name: "NextMaster",
    description: "A highly performant replica of McMaster-Carr using Next.js 15",
