...
const content = `
Your privacy is important to us. It is Nextradar.dev's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, Nextradar.dev, and other sites we own and operate.
...
This policy is effective as of 26 Oct 2024.
...
Additional Disclosures for General Data Protection Regulation (GDPR) Compliance (EU) Data Controller / Data Processor The GDPR distinguishes between organisations that process personal information for their own purposes (known as “data controllers”) and organizations that process personal information on behalf of other organizations (known as “data processors”). We, Nextradar.dev, located at the address provided in our Contact Us section, are a Data Controller with respect to the personal information you provide to us.
...
Your Rights and Controlling Your Personal Information 2
...
Ali Hussein hi@nextradar.dev
`
//======================================
const TosPage = () => {
  return (
    <div className="px-2 pb-16">
      <h1 className="mb-4 border-b pb-1 text-2xl font-bold dark:border-zinc-800">
        Terms of Service
      </h1>
