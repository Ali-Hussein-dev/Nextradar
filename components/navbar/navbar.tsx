...
const navVariants = cva("mx-auto", {
  variants: {
    variant: {
      default: "max-w-7xl",
      centered: "max-w-4xl rounded-full mt-2 border shadow-lg dark:border-zinc-900",
    },
  },
  defaultVariants: {
    variant: "default",
...
export interface NavProps extends VariantProps<typeof navVariants> {
   ...
   */
  mobileItems: (props: { setIsOpen: (open: boolean) => void }) => React.ReactNode
  /**
...
//======================================
export const Navbar = ({ Logo, sticky, variant, mobileItems, desktopItems }: NavProps) => {
  return (
    <header
      className={cn(
