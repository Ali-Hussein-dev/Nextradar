  ...
  return (
    <section>
      <ExpandableCard className="md:px-6 border-dashed h-full typography mb-6">
        <CardHeading
          h2={`Best Headless CMS for Next.js ${new Date().getFullYear()}`}
        />
        <div>
          <p>
          ...
          <p>
            From Sanity&apos;s real-time collaboration features to Contentful&apos;s
            robust API-first approach, explore the unique strengths of each CMS
            to find your ideal match. Whether you&apos;re building a blog, e-commerce
            site, or enterprise-level application, our in-depth analysis covers
            key features, pricing, and use cases to help you make an informed
            decision.{" "}
          </p>
          <p>
            ...
            content management and boost your site&apos;s performance – dive into our
            guide and revolutionize your Next.js projects today!
          </p>
        </div>
      </ExpandableCard>
